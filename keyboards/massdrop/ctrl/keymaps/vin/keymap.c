...
#define MT_C2E MT(MOD_LCTL, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /*
    [_] = LAYOUT(
        Esc,    F1,   F2,   F3,  F4,   F5,  F6,   F7,   F8,   F9,    F10, F11,    F12,            PrtScn, ScrLck, Pause,
        ~,      1,    2,    3,   4,    5,   6,    7,    8,    9,     0,   -,      =,    BkSpc,    Ins,    Home,   PgUp
        Tab,    Q,    W,    E,   R,    T,   Y,    U,    I,    O,     P,   {,      },    \,        Del,    End,    PgDn
        Caps,   A,    S,    D,   F,    G,   H,    J,    K,    L,     :,   ",      Enter
        LShift, Z,    X,    C,   V,    B,   N,    M,    <,    >,     ?,   RShift,                         Up
        LCtrl,  LWin, LAlt,      Spc,       RAlt, RWin, Menu, RCtrl,                              Left,   Down,   Right
    ),
    */
    [0] = LAYOUT(
    ...
    [1] = LAYOUT(
        ...
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   L_EDG_I, _______, _______, _______, U_T_AGCR,_______, _______, _______, _______, _______,   KC_MPLY, KC_MSTP, KC_MUTE,   \
        ...
        _______, _______, _______,                   DBG_FAC,                            _______, _______, _______, _______,            KC_RWPRV, KC_VOLD, KC_FFNXT  \
    ),
    /*
    [X] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
